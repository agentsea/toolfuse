...
def test_action_initialization_and_call():
    ...
    action_instance = Action('test_action', mock_method, {'schema_key': 'schema_value'}, 'Test action description')
...
def test_observation_initialization_and_call():
    ...
    observation_instance = Observation('test_observation', mock_method, {'schema_key': 'schema_value'}, 'Test observation description')
